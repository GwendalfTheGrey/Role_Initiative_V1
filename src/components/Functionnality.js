export default function Functionnality({functionnalities}) {
    return (
...
// {`section-spacing ${functionnality.id % 2 === 0 && 'even-bg'}`}
        ...
        <article className={`section-spacing article-spacing article-paragraph ${functionnality.id % 2 === 0 && 'even-bg'}`}>
            ...
            <div className='d-flex aifs'>
                <svg className='bulletpoint flex-fill' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39 34.4">
                    <g>
            ...
            <div className='d-flex aifs'>
                ...
                <p>
                    {functionnality.secondParagraph}
                </p>
            </div>
        </article>
        ))
